...
class Builder implements Mp.MenuBuilder<Electron.Menu> {
    ...
    async popup(menu: Electron.Menu, x: number, y: number): Promise<void> {
        menu.popup({ x, y });
    }

    changeTheme(_menu: Electron.Menu, _theme: Mp.Theme): void {
        // nothing to do
    }
